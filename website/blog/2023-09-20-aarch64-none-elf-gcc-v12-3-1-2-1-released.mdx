...
seo_title: Version 12.3.1-2.1 released
description: Version 12.3.1-2.1 is a maintenance release of xPack GNU AArch64 Embedded GCC.
keywords:
  - xpack
...
Version **12.3.1-2.1** is a maintenance release; it fixes the GNU/Linux GDB issues with loading ELF files.
