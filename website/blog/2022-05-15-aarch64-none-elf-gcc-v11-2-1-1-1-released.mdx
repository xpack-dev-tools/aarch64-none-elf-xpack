...
seo_title: Version 11.2.1-1.1 released
description: Version 11.2.1-1.1 is a new release of xPack GNU AArch64 Embedded GCC.
keywords:
  - xpack
...
Version **11.2.1-1.1** is a new release; it follows the upstream Arm release.
