...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/aarch64-none-elf-gcc@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-{customField('xpackVersion')}-win32-x64.zip</code></li>
</ul>
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-aarch64-none-elf-gcc-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-aarch64-none-elf-gcc-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-aarch64-none-elf-gcc-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
