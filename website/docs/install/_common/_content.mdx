...
The easiest (and recommended) way to install xPack GNU AArch64 Embedded GCC
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/aarch64-none-elf-gcc@14.2.1-1.1.1 --verbose
`} </CodeBlock>
...
* add <code>@xpack-dev-tools/aarch64-none-elf-gcc</code> to
  `package.json` as a
  development dependency; this associates a specific version of xPack GNU AArch64 Embedded GCC with
...
it is also possible to install xPack GNU AArch64 Embedded GCC only globally in
...
In order to access the xPack GNU AArch64 Embedded GCC binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/aarch64-none-elf-gcc/14.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/aarch64-none-elf-gcc/14.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/aarch64-none-elf-gcc/14.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-14.2.1-1.1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\aarch64-none-elf-gcc\\xpack-aarch64-none-elf-gcc-14.2.1-1.1</code>.
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-14.2.1-1.1-darwin-x64.tar.gz</code></li>
<li><code>xpack-aarch64-none-elf-gcc-14.2.1-1.1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/aarch64-none-elf-gcc/xpack-aarch64-none-elf-gcc-14.2.1-1.1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/aarch64-none-elf-gcc
cd ~/Library/xPacks/aarch64-none-elf-gcc

tar xvf ~/Downloads/xpack-aarch64-none-elf-gcc-14.2.1-1.1-darwin-x64.tar.gz
chmod -R -w xpack-aarch64-none-elf-gcc-14.2.1-1.1
`} </CodeBlock>
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-14.2.1-1.1-linux-x64.tar.gz</code></li>
<li><code>xpack-aarch64-none-elf-gcc-14.2.1-1.1-linux-arm64.tar.gz</code></li>
<li><code>xpack-aarch64-none-elf-gcc-14.2.1-1.1-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/aarch64-none-elf-gcc/xpack-aarch64-none-elf-gcc-14.2.1-1.1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/aarch64-none-elf-gcc
cd ~/.local/xPacks/aarch64-none-elf-gcc

tar xvf ~/Downloads/xpack-aarch64-none-elf-gcc-14.2.1-1.1-linux-x64.tar.gz
chmod -R -w xpack-aarch64-none-elf-gcc-14.2.1-1.1
`} </CodeBlock>
