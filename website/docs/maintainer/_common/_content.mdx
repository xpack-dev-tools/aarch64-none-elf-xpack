...
the **[Update the version specific code](http://localhost:3000/aarch64-none-elf-gcc-xpack/docs/maintainer/#update-the-version-specific-code)** section.
...
named like **xPack GNU AArch64 Embedded GCC v14.2.1-1.1** (mind the dash),
...
- add entries in the **Bug fixes**; use the following syntax
  ```
  - [[#N](https://github.com/xpack-dev-tools/aarch64-none-elf-gcc-xpack/issues/N)]:
  ```
...
- paste the release name like _**xPack GNU AArch64 Embedded GCC v14.2.1-1.1 released**_
...
[![Github All Releases](https://img.shields.io/github/downloads/xpack-dev-tools/aarch64-none-elf-gcc-xpack/latest/total)](https://github.com/xpack-dev-tools/aarch64-none-elf-gcc-xpack/releases)
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Faarch64-none-elf-gcc?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/aarch64-none-elf-gcc/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Faarch64-none-elf-gcc)](https://www.npmjs.com/package/@xpack-dev-tools/aarch64-none-elf-gcc/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Faarch64-none-elf-gcc)](https://www.npmjs.com/package/@xpack-dev-tools/aarch64-none-elf-gcc/)
