...
function application_build_versioned_components()
{
  ...
  then
    ...
    then
      ...
      # https://developer.arm.com/-/media/Files/downloads/gnu/14.2.rel1/srcrel/arm-gnu-toolchain-src-snapshot-14.2.rel1-manifest.txt

      XBB_ARM_RELEASE="14.2.rel1"
      ...
      # Revision: 74c7803f0cc8d3d66513b6d6549bff2fbe737a7d (from manifest.txt
      # or release notes)

      # https://github.com/xpack-dev-tools/binutils-gdb/tags

      XBB_BINUTILS_VERSION="2.43"
      ...
      # Revision: b7918205e0010f1f23ce1f8f82a88b820bf74d4a (from manifext.txt
      # or release notes)

      # https://github.com/xpack-dev-tools/binutils-gdb/tags/

      # From `gdb/version.in`
      XBB_GDB_VERSION="15.2"
      XBB_GDB_TAG_NAME="gdb-15-arm-none-eabi-${XBB_ARM_RELEASE}"
      ...
      # Revision: a05ea1e5ee0867191bb432a84c055be99dbdbc16 (from manifext.txt
      # or release notes)
    ...
    XBB_LIBXCRYPT_VERSION="4.4.36" # "4.4.33"
  ...
  then
    ...
    then
      # https://developer.arm.com/-/media/Files/downloads/gnu/13.3.rel1/manifest/arm-gnu-toolchain-aarch64-none-elf-abe-manifest.txt
      ...
      XBB_GDB_TAG_NAME="gdb-14-aarch64-none-elf-${XBB_ARM_RELEASE}"
    ...
    then
      ...
      # Revision: 8a6295d22f3a8c2c4ae7f4237657cb1be4833bbb (from manifest.txt
      # or release notes)

      # https://github.com/xpack-dev-tools/binutils-gdb/tags

      XBB_BINUTILS_VERSION="2.41"
      XBB_BINUTILS_TAG_NAME="binutils-${XBB_BINUTILS_VERSION}-aarch64-none-elf-${XBB_ARM_RELEASE}"
      ...
      # Revision: c987953c1028fce9ea6080fdfbbc7d25192be69e (from manifext.txt
      # or release notes)
      ...
      # Arm: release notes.
      # Repository: git://gcc.gnu.org/git/gcc.git
      # Branch: refs/vendors/ARM/heads/arm-13
      # Revision: ?
    ...
    # https://www.openssl.org/source/
    XBB_OPENSSL_VERSION="1.1.1w" # "1.1.1s"
